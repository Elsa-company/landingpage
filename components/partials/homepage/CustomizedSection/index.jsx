                ...
                <Container>
                    ...
                    <Styled.Collapse>
                        <Styled.CollapseWrapper>
                            <Styled.CollapseItem>
                                <Styled.CollapseItemHeader active={key == 1 ? "true" : "false"} onClick={() => { changeContent(1) }}>
                                    <i>
                                        {key == 1 ?
                                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="23" cy="23" r="23" fill="#238DE0" />
                                    ...
                                    <p>ELSA for airlines</p>
                                </Styled.CollapseItemHeader>
                                <Styled.CollapseContent active={key == 1 ? "true" : "false"}>
                                    <Styled.Image>
                                        <img src={quote.mainImage} alt="main picture" />
                                    </Styled.Image>
                                    <Styled.QuoteWrapperTitle >
                            ...
                            <Styled.CollapseItem>
                                <Styled.CollapseItemHeader active={key == 2 ? "true" : "false"} onClick={() => { changeContent(2) }}>
                                    <i>
                                        {key == 2 ?
                                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="23" cy="23" r="23" fill="#238DE0" />
                                ...
                                <Styled.CollapseContent active={key == 2 ? "true" : "false"}>
                                    <Styled.Image>
                                        <img src={quote.mainImage} alt="main picture" />
                                    </Styled.Image>
                                    <Styled.QuoteWrapperTitle >
                            ...
                            <Styled.CollapseItem>
                                <Styled.CollapseItemHeader active={key == 3 ? "true" : "false"} onClick={() => { changeContent(3) }}>
                                    <i>
                                        {key == 3 ?
                                            <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="23" cy="23" r="23" fill="#238DE0" />
                                ...
                                <Styled.CollapseContent active={key == 3 ? "true" : "false"}>
                                    <Styled.Image>
                                        <img src={quote.mainImage} alt="main picture" />
                                    </Styled.Image>
                                    <Styled.QuoteWrapperTitle >
                            ...
                            <Styled.CollapseItem>
                                <Styled.CollapseItemHeader active={key == 4 ? "true" : "false"} onClick={() => { changeContent(4) }}>
                                    <i>
                                ...
                                <Styled.CollapseContent active={key == 4 ? "true" : "false"}>
                                    <Styled.Image>
                                        <img src={quote.mainImage} alt="main picture" />
                                    </Styled.Image>
                                    <Styled.QuoteWrapperTitle >
