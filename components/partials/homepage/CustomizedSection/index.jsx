...
const CustomizedSection = () => {
    ...
    const [quote, setQuote] = useState({
        ...
        quotes: {
            text: "We have partnered with pioneering airlines to offer training to thousands of cabin crew members.",
            link: {
    ...
    const changeContent = (key) => {
        ...
        if (key == 1) {
            ...
            setQuote({
                ...
                quotes: {
                    text: "Achieving the world-class hospitability customer service is not easy and ELSA is here to help.",
            ...
            setQuote({
                ...
                quotes: {
                    text: "English communication is a must-have skill for IT staff in the international environment. Ready to build the global workforce with ELSA?",
            ...
            setQuote({
                ...
                quotes: {
                    text: "ELSA can help call center companies increase customer satisfaction and most importantly, win new business.",
                    quote: "Training cooperation with ELSA Speak is one of the strategic steps for human resource development of ATAD. ",
                    author: "Ms. Le Diem",
